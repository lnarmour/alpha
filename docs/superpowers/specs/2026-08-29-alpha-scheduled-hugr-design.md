...
constants, identifiers, arithmetic, comparisons, Boolean combinations, plain and rounded
division, and min/max where generated by ISL. Unsupported ISL expression kinds produce a diagnostic at
translation time.
